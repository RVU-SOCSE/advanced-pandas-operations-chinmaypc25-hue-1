...
avg_salary_per_dept = employee_details.merge(
    employee_salaries, on='EmployeeID'
...
merged_data = pd.merge(
    employee_details, employee_salaries,
...
consolidated_sales = pd.concat(
    [sales_region_1, sales_region_2],
    axis=0
)
